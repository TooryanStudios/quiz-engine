...
export const createPlatformRateLimitService = ({
  ...
  const limits = {
    ...
    workflowGetUserPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_WORKFLOW_GET_PER_MINUTE_USER, 120),
    workflowGetIpPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_WORKFLOW_GET_PER_MINUTE_IP, 240),
    workflowListUserPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_WORKFLOW_LIST_PER_MINUTE_USER, 60),
    workflowListIpPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_WORKFLOW_LIST_PER_MINUTE_IP, 120),
    ...
    uploadMutateUserPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_MUTATE_PER_MINUTE_USER, 120),
    uploadMutateIpPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_MUTATE_PER_MINUTE_IP, 200),
    uploadGetUserPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_GET_PER_MINUTE_USER, 150),
    uploadGetIpPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_GET_PER_MINUTE_IP, 300),
    uploadListUserPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_LIST_PER_MINUTE_USER, 80),
    uploadListIpPerMinute: parseNonNegativeInt(process.env.PLATFORM_LIMIT_UPLOAD_LIST_PER_MINUTE_IP, 160),
  };
