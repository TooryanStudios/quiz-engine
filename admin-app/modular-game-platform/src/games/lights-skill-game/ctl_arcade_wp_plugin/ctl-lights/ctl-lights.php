<?php
    /*
    Plugin Name: CTL Arcade - Lights
    Plugin URI: http://www.codethislab.com/
    Description: Lights for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeLights{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-lights";
        private $_szPluginName              = "Lights";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "circuit puzzle, confuse box, circuit, skill game, brain game, addictive, logic game, matching game, flow, puzzle, educational game, circuit scramble, electric circuit, brain teaser, led, light";
    ...
    $g_oCTLArcadeLights =  new CTLArcadeLights();
