function CWinPanel(iMode, iTimeSpent, iLevel, iLevelStars){    
    ...
    this._init = function(){
        ...
        // DIAGNOSTIC: Confirm correct file is loaded
        var oDiagnosticText = new createjs.Text("CONFIG SYSTEM ACTIVE - Build: 2026-03-18-19:00", "bold 16px Arial", "#00FF00");
        oDiagnosticText.x = 10;
        oDiagnosticText.y = 10;
        oDiagnosticText.shadow = new createjs.Shadow("#000000", 2, 2, 4);
        _oContainer.addChild(oDiagnosticText);
