...
/**
 * Memoized Layer — skips re-render when only selection state changes.
 * Selection is handled separately via SortedOutlines / EditorInteractionContext.
 */
export const Layer = React.memo(LayerInner);