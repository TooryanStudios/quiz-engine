  ...
  return (
    <div className="flex items-center gap-1 w-full sm:w-48 z-50">
      ...
      <Button
        ...
        variant="ghost"
        size="icon"
        className="h-8 w-8 sm:h-6 sm:w-6 text-gray-500 dark:text-zinc-400 hover:bg-[hsl(0_0%_22%)]"
      ...
      <Button
        ...
        variant="ghost"
        size="icon"
        className="h-10 w-10 sm:h-6 sm:w-6 text-gray-500 dark:text-zinc-400 hover:bg-[hsl(0_0%_22%)]"
