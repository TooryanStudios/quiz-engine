...
export interface TimelineProps {
  ...
  // Collapse controls
  collapsed?: boolean; // Controlled collapse state from parent timeline section
  onCollapseChange?: (collapsed: boolean) => void; // Callback when timeline collapse state changes
  // Gap removal controls
  gapRemovalEnabled?: boolean; // Whether timeline gap close indicators are enabled
  onGapRemovalEnabledChange?: (enabled: boolean) => void; // Callback to toggle gap removal mode
...
export interface TimelineContentProps {
  ...
  hideItemsOnDrag?: boolean; // Whether to hide selected timeline items during drag operations (default: false)
  // Gap removal controls
  gapRemovalEnabled?: boolean; // Whether track gap close indicators are visible/active
  // Snapping controls
  snappingEnabled?: boolean; // Whether edge/grid snapping is enabled during drag
} 