...
const usePathname = () => window.location.pathname; const useSearchParams = () => new URLSearchParams(window.location.search);
...
export function PostHogProvider({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    ...
    if (isPostHogEnabled) {
      ...
      if (typeof window !== "undefined" && env.MODE === "production") {
