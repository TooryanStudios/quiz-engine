...
const RenderControls: React.FC<RenderControlsProps> = ({
  ...
  // Rendering is enabled by default for local/dev use.
  // Set VITE_RENDERING_ENABLED=false (or NEXT_PUBLIC_RENDERING_ENABLED=false)
  // to force-disable it.
  const renderingEnabledFlag = env.VITE_RENDERING_ENABLED ?? env.NEXT_PUBLIC_RENDERING_ENABLED;
  const isRenderingEnabled = renderingEnabledFlag !== "false";
  ...
  return (
    <>
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <div className="text-[11px] text-muted-foreground">
                      ...
                      {render.error && (
                        <div
                          className="text-red-400 mt-0.5 truncate max-w-45"
                          title={render.error}
                        >
                          {render.error}
                        </div>
      ...
      <Button
        ...
        title={!isRenderingEnabled ? "Rendering is disabled by VITE_RENDERING_ENABLED=false" : undefined}
      >
        {!isRenderingEnabled ? (
          "Render Video"
