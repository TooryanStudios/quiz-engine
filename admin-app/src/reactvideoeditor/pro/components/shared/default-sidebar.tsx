...
export const DefaultSidebar: React.FC<DefaultSidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      <Sidebar
        collapsible="none"
        className="sidebar-icon-rail w-[calc(var(--sidebar-width-icon)+1px)]! border-r border-border"
      >
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      {activePanel === item.panel && (
                        <span
                          aria-hidden="true"
                          className="pointer-events-none absolute bottom-0 left-1/2 h-0.75 w-5 -translate-x-1/2 rounded-full bg-blue-500"
                        />
                      )}
                    </SidebarMenuButton>
                  </TooltipTrigger>
