    ...
    try {
      ...
      if (itemType === 'video' && itemData?.data) {
        ...
        newOverlay = {
          ...
          localMediaId: video._isLocalMedia ? video.id : undefined,
        ...
        newOverlay = {
          ...
          localMediaId: image._isLocalMedia ? image.id : undefined,
          content: imageUrl,
          src: imageUrl,
          styles: {
            opacity: 1,
        ...
        newOverlay = {
          ...
          localMediaId: sound._isLocalMedia ? sound.id : undefined,
