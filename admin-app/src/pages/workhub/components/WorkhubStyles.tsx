...
const WorkhubStyles = memo(function WorkhubStyles({ phoneMaxWidth = 767 }: WorkhubStylesProps) {
  return (
    <style>{`
      ...
      .workhub-action-menu-item.is-project-action {
        background: #f0f6ff;
        color: #18458e;
      }
      .workhub-action-menu-item.is-project-action .workhub-action-icon {
        background: #e4efff;
        border-color: #b8cdf7;
        color: #245bb8;
      }
      .workhub-action-menu-item.is-folder-action {
        background: #f7f3ea;
        color: #5d4a28;
      }
      .workhub-action-menu-item.is-folder-action .workhub-action-icon {
        background: #fff4dd;
        border-color: #e9cea0;
        color: #8b641f;
      }
      ...
      .workhub-project-card.compact-card.is-category-card {
        border: 1px solid color-mix(in srgb, var(--workhub-category-accent, #8aaef1) 50%, #dce7fb 50%);
        border-left: 4px solid var(--workhub-category-accent, #8aaef1);
      ...
      .workhub-project-card.compact-card.is-category-card:hover {
        border-color: color-mix(in srgb, var(--workhub-category-accent, #8aaef1) 70%, #c9d8f4 30%);
      ...
      .workhub-project-category-icon {
        ...
        align-items: center;
        justify-content: center;
        background: color-mix(in srgb, var(--workhub-category-accent, #8aaef1) 14%, #ffffff 86%);
        color: #24467b;
        font-size: 0.95rem;
        flex-shrink: 0;
      }
      ...
      .workhub-category-card-copy .workhub-badge {
        width: fit-content;
      }
