...
export function MyQuizzesPage() {
  ...
  const t = {
    ...
    searchPlaceholder: isAr ? 'البحث في الاختبارات...' : 'Search challenges...',
    all: isAr ? 'الكل' : 'All',
    ...
    makePrivateConfirm: isAr ? 'جعل الاختبار خاصاً؟ لن يظهر في المكتبة بعد الآن.' : 'Make challenge private? It will no longer appear in the library.',
    ...
    noQuizzesYet: isAr ? 'لا توجد اختبارات بحسابك حتى الآن' : 'No challenges yet',
