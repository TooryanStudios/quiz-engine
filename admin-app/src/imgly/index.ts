...
// Background removal requires: npm install @imgly/background-removal onnxruntime-web
...
export async function initVideoEditor(cesdk: CreativeEditorSDK) {
  // Suppress the "No scene found" warning — scene is created at end of init.
  ...
  // Background removal disabled — requires: npm install @imgly/background-removal onnxruntime-web
